  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-slate-800">
      <div className="flex flex-col my-6 space-y-6 md:space-y-0 md:space-x-6 md:flex-row md:my-0">
        ...
        <div className="bg-violet-800 rounded-xl text-white">
          <div className="p-8 mx-3 mt-3 rounded-t-xl bg-slate-800">
            ...
            <div className="flex-justify-center">
              <a
                ...
                target="_blank"
                href="https://google.com"
                className="inline-block px-10 py-3 my-6 text-center border border-violet-600 bg-violet-600 rounded-lg duration-200 hover:bg-violet-800 hover:border-violet-800"
              >
                Purchase
              </a>
            </div>
        ...
        <div className="bg-slate-700 rounded-xl text-white">
          <div className="p-8 mx-3 mt-3 rounded-t-xl bg-slate-800">
            ...
            <h2 className="mt-10 font-serif text-5xl text-center">1000GB</h2>
          ...
          <div className="p-8 mx-3 mb-3 rounded-b-xl bg-slate-800">
            <div className="flex flex-col space-y-2">
              <div className="flex justify-center">
                ...
                <span className="text-sm ml-1">1000 GB of storage</span>
              </div>
            </div>
          </div>
        </div>
